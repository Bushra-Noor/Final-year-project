    ...
    <!-- Input mask Js -->
    <script src="<?php echo e(asset('dashboard/plugins/inputmask/js/autoNumeric.js')); ?>"></script>

    <!-- minicolors Js -->
    <script src="<?php echo e(asset('dashboard/plugins/mini-color/js/jquery.minicolors.min.js')); ?>"></script>
    ...
    <script type="text/javascript">
      ...
      tinymce.init({
        ...
        directionality : 'rtl',
        language: '<?php echo e($version->code); ?>',
      });
    </script>
    <?php else: ?>
    <script type="text/javascript">
    ...
    <?php endif; ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/layouts/common/footer_script.blade.php ENDPATH**/ ?>