        ...
        <!-- minicolors css -->
        <link rel="stylesheet" href="<?php echo e(asset('dashboard/plugins/mini-color/css/jquery.minicolors.css')); ?>">
        <!-- toastr css -->
        ...
        <!-- vendor css -->
        <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/style.css')); ?>" type="text/css" media="screen, print">
        ...
        <!-- RTL css -->
        <link rel="stylesheet" href="<?php echo e(asset('dashboard/css/layouts/rtl.css')); ?>" type="text/css" media="screen, print">
        <?php endif; ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/layouts/common/header_script.blade.php ENDPATH**/ ?>