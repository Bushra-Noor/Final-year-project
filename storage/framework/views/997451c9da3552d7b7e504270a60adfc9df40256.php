                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(isset($row->hostelRoom)): ?>
                                            <?php echo e($row->hostelRoom->room->name ?? ''); ?> (<?php echo e($row->hostelRoom->room->roomType->title ?? ''); ?>)
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($row->hostelRoom->room->hostel->name ?? ''); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if(isset($row->hostelRoom)): ?>
                                            <?php if( $row->hostelRoom->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/hostel-student/index.blade.php ENDPATH**/ ?>