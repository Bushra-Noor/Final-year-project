                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('field_logo_left')); ?></th>
                                        <th><?php echo e(__('field_border_background')); ?></th>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(isset($row->background) && is_file('uploads/'.$path.'/'.$row->background)): ?>
                                            <img src="<?php echo e(asset('uploads/'.$path.'/'.$row->background)); ?>" class="img-fluid" style="max-width: 80px; max-height: 80px;">
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/certificate-template/index.blade.php ENDPATH**/ ?>