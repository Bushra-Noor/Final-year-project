                            ...
                            <div class="table-responsive">
                                <table class="table nowrap table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo e(__('School Info')); ?></td>
                                            <td>
                                                <input name="ids[]" type="hidden" value="<?php echo e($field->id); ?>">
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo e(__('Collage Info')); ?></td>
                                            <td>
                                                <input name="ids[]" type="hidden" value="<?php echo e($field->id); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/field/application.blade.php ENDPATH**/ ?>