                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="faculty" id="faculty" required>
                                    ...
                                    <option value="<?php echo e($faculty->id); ?>" <?php if(old('faculty') == $faculty->id): ?> selected <?php endif; ?>><?php echo e($faculty->title); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="shortcode" id="shortcode" value="<?php echo e(old('shortcode')); ?>" required>
                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('field_shortcode')); ?></th>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->shortcode); ?></td>
                                        <td><?php echo e($row->faculty->title ?? ''); ?></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/program/index.blade.php ENDPATH**/ ?>