              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="shortcode" id="shortcode" value="<?php echo e($row->shortcode); ?>">
    ...
    </div><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/faculty/edit.blade.php ENDPATH**/ ?>