              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="note" id="note" required><?php echo e($row->description); ?></textarea>
    ...
    </div><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/student-note/edit.blade.php ENDPATH**/ ?>