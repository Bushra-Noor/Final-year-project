                ...
                <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group ">
                                <label for="attach"><?php echo e(__('field_photo')); ?> <span><?php echo e(__('image_size', ['height' => 300, 'width' => 300])); ?></span> <span>*</span></label>
                                  ...
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img style="width:50px; height:auto;" src="<?php echo e(asset('uploads/'.$path.'/'.$row->attach)); ?>" alt="" srcset="">
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/web/testimonial/index.blade.php ENDPATH**/ ?>