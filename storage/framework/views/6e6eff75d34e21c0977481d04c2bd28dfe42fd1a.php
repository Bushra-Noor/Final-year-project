...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if(Route::has('student.password.request')): ?>
            <p class="mb-2 text-muted">
                <a href="<?php echo e(route($forgotPasswordRoute)); ?>">
        ...
        <?php if(Route::has('student.register')): ?>
...
<?php echo $__env->make('auth.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/web/student/login.blade.php ENDPATH**/ ?>