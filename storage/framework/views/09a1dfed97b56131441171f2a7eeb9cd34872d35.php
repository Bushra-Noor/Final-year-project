    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card theme-bg bitcoin-wallet">
                    <div class="card-block">
                        <h5 class="text-white mb-2"><?php echo e(__('field_daily')); ?> <?php echo e(trans_choice('module_postal_exchange', 2)); ?></h5>
                        <h2 class="text-white mb-2 f-w-300"><?php echo e($daily_postals->count()); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/index.blade.php ENDPATH**/ ?>