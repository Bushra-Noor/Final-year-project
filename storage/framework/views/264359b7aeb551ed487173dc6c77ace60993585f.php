                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="student" class="form-label"><?php echo e(__('field_student')); ?> <span>*</span></label>
                                <select class="form-control select2" name="student" id="student" required>
                                    <option value=""><?php echo e(__('select')); ?></option>
                                    <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($student->id); ?>" <?php if(old('student') == $student->id): ?> selected <?php endif; ?>><?php echo e($student->student_id); ?> - <?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></option>
                            ...
                            <div class="form-group">
                                <label for="note" class="form-label"><?php echo e(__('field_note')); ?> <span>*</span></label>
                                <textarea class="form-control" name="note" id="note" required><?php echo e(old('note')); ?></textarea>
                            ...
                            <div class="form-group">
                                <label for="attach" class="form-label"><?php echo e(__('field_attach')); ?></label>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(isset($row->noteable->student_id)): ?>
                                            <a href="<?php echo e(route('admin.student.show', $row->noteable->id)); ?>">
                                            #<?php echo e($row->noteable->student_id ?? ''); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/student-note/index.blade.php ENDPATH**/ ?>