...
<?php $__env->startSection('social_meta_tags'); ?>
    ...
    <meta property='og:description' content="<?php echo str_limit(strip_tags($event->description), 160, ' ...'); ?>"/>
    <meta property='og:url' content="<?php echo e(route('event.single', ['id' => $event->id, 'slug' => $event->slug])); ?>"/>
    <meta property='og:image' content="<?php echo e(asset('uploads/web-event/'.$event->attach)); ?>"/>


    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="<?php echo '@'.str_replace(' ', '', $setting->title); ?>" />
    <meta name="twitter:creator" content="@HiTechParks" />
    <meta name="twitter:url" content="<?php echo e(route('event.single', ['id' => $event->id, 'slug' => $event->slug])); ?>" />
    <meta name="twitter:title" content="<?php echo e($event->title); ?>" />
    <meta name="twitter:description" content="<?php echo str_limit(strip_tags($event->description), 160, ' ...'); ?>" />
    <meta name="twitter:image" content="<?php echo e(asset('uploads/web-event/'.$event->attach)); ?>" />
    <?php endif; ?>
            ...
            <div class="container">
                ...
                <div class="upper-box">
                    <div class="single-item-carousel owl-carousel owl-theme">
                        <figure class="image"><img src="<?php echo e(asset('uploads/web-event/'.$event->attach)); ?>" alt="Event"></figure>
                    </div>
                </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row aling-items-center">
                                         <div class="image-column col-xl-6 col-lg-12 col-md-12">
                                            <div class="footer-social mt-10">
                                                <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(route('event.single', ['id' => $event->id, 'slug' => $event->slug])); ?>">
                                                    <i class="fab fa-facebook-f"></i>
                                                </a>
                                                
                                                <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo e(str_limit(strip_tags($event->title), 100, ' ...')); ?>&url=<?php echo e(route('event.single', ['id' => $event->id, 'slug' => $event->slug])); ?>">
                                                    <i class="fab fa-twitter"></i>
                                                </a>

                                                <a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(route('event.single', ['id' => $event->id, 'slug' => $event->slug])); ?>">
                        ...
                        <div class="info-column col-lg-3 col-md-12 col-sm-12">
                            <div class="inner-column2">
                                <h3><?php echo e(__('sidebar_event')); ?></h3>
                                ...
                                <ul class="project-info clearfix">
                                    ...
                                    <li>
                                        ...
                                        <strong><?php echo e(date("d F, Y", strtotime($event->date))); ?></strong>
                                    </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HorizonCollege\resources\views/web/event-single.blade.php ENDPATH**/ ?>