                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="province"><?php echo e(__('field_province')); ?> <span>*</span></label>
                                <select class="form-control" name="province" id="province" required>
                                    <option value=""><?php echo e(__('select')); ?></option>
                                    <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($province->id); ?>" <?php if(old('province') == $province->id): ?> selected <?php endif; ?>><?php echo e($province->title); ?></option>
                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('field_province')); ?></th>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->province->title ?? ''); ?></td>
                                        <td>
                                            <?php if( $row->status == 1 ): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/district/index.blade.php ENDPATH**/ ?>