                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="invoice_id" id="invoice_id" value="<?php echo e($row->invoice_id); ?>">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="amount" id="amount" value="<?php echo e(round($row->amount)); ?>" required>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/income/edit.blade.php ENDPATH**/ ?>