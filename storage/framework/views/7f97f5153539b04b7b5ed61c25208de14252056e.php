              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="floor" id="floor" value="<?php echo e($row->floor); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control autonumber" name="capacity" id="capacity" value="<?php echo e($row->capacity); ?>" data-v-max="999999999" data-v-min="0">
    ...
    </div><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/room/edit.blade.php ENDPATH**/ ?>