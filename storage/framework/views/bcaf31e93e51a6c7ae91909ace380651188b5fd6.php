                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="sub_title" id="sub_title" rows="4"><?php echo e($row->sub_title); ?></textarea>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="button_text" id="button_text" value="<?php echo e($row->button_text); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="url" class="form-control" name="button_link" id="button_link" value="<?php echo e($row->button_link); ?>">
                        ...
                        <div class="form-group col-md-6">
                            <label for="attach"><?php echo e(__('field_thumbnail')); ?>: <span><?php echo e(__('image_size', ['height' => 850, 'width' => 1920])); ?></span></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HorizonCollege\resources\views/admin/web/slider/edit.blade.php ENDPATH**/ ?>