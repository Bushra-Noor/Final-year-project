                ...
                <?php echo csrf_field(); ?>
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="shortcode" class="form-label"><?php echo e(__('field_shortcode')); ?></label>
                                <input type="text" class="form-control" name="shortcode" id="shortcode" value="<?php echo e(old('shortcode')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/faculty/index.blade.php ENDPATH**/ ?>