                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="province" id="province" required>
                            ...
                            <option value="<?php echo e($province->id); ?>" <?php if($row->province_id == $province->id): ?> selected <?php endif; ?>><?php echo e($province->title); ?></option>
    ...
    </div><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/district/edit.blade.php ENDPATH**/ ?>