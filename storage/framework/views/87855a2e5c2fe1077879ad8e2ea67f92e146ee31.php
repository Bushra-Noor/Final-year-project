...
<div class="form-group col-md-2">
  ...
  <select class="form-control semester" name="semester" id="semester">
		...
		<option value="<?php echo e($semester->id); ?>" <?php if( old('semester') == $semester->id): ?> selected <?php endif; ?>><?php echo e($semester->title); ?></option>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		<?php endif; ?>
	</select>
...
<div class="form-group col-md-2">
  <label for="section"><?php echo e(__('field_section')); ?> <span>*</span></label>
	<select class="form-control section" name="section" id="section">
		...
		<option value="<?php echo e($section->id); ?>" <?php if( old('section') == $section->id): ?> selected <?php endif; ?>><?php echo e($section->title); ?></option>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		<?php endif; ?>
	</select>
    ...
    $(".program").on('change',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.session').append('<option value="0"><?php echo e(__("all")); ?></option>');
            $.each(response, function(){
              $('<option/>', {
                'value': this.id,
                'text': this.title
...
</script><?php /**PATH C:\xampp\htdocs\HorizonCollege\resources\views/common/inc/notify_search_filter.blade.php ENDPATH**/ ?>