              ...
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control color_picker" name="color" id="color" value="<?php echo e($row->color); ?>" required>
    ...
    </div><?php /**PATH C:\xampp\htdocs\HorizonCollege\resources\views/admin/event/edit.blade.php ENDPATH**/ ?>