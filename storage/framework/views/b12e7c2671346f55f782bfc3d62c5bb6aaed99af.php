                    ...
                    <div class="card-block">
                        <form class="needs-validation" novalidate method="get" action="<?php echo e(route($route.'.index')); ?>">
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="room_type"><?php echo e(__('field_type')); ?></label>
                                    <select class="form-control" name="room_type" id="room_type">
                                        ...
                                        <option value="<?php echo e($room_type->id); ?>" <?php if($selected_room_type == $room_type->id): ?> selected <?php endif; ?>><?php echo e($room_type->title); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <table id="export-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(__('field_total')); ?> <?php echo e(__('field_bed')); ?></th>
                                        <th><?php echo e(__('status_available')); ?></th>
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->hostel->name ?? ''); ?></td>
                                        <td><?php echo e($row->roomType->title ?? ''); ?></td>
                                        <td><?php echo e($row->bed); ?></td>
                                        <td><?php echo e($row->bed - $row->hostelMembers->where('status', '1')->count()); ?></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversitySystem\resources\views/admin/hostel-room/index.blade.php ENDPATH**/ ?>